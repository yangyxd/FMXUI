...
function SetClipboardTxt(const txt: string): Boolean;
var
  AClipboard: IFMXClipboardService;
begin
  if TPlatformServices.Current.SupportsPlatformService(IFMXClipboardService, AClipboard) then begin
