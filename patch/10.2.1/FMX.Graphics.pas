...
var
  ...
  PathString, Tokens, LastToken: string;
        ...
        case Token of
          ...
          'q':
            begin
              ...
              while HasRelativeOffset(PathString, Pos) do begin
                CurvePoint1 := GetPointFromString(PathString, Pos);
                CurvePoint2 := GetPointFromString(PathString, Pos);
                LastQCtrlPoint:=CurvePoint1+LastPoint;
                QuadCurveTo(LastQCtrlPoint, LastPoint+CurvePoint2);
          ...
          'A', 'a':
            begin      
              ...
              // ----- begin  -----
              // 加上这2行 by YangYxd
              if (Pos < PathString.Length) and (('0123456789.-'.Contains(PathString.Chars[Pos]))) then
